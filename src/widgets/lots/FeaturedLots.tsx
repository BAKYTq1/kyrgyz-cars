  ...
  return (
    <section className="bg-white py-10 px-4">
      <div className="max-w-7xl mx-auto space-y-10">
        {/* Секция: Активные лоты */}
        <div>
          <div className="flex items-center justify-between mb-4">
            <div className="flex items-center gap-2">
              <h2 className="text-lg font-bold text-gray-900">
                {t("featuredLots.activeTitle")}
              </h2>
              {total > 0 && (
            ...
            <Link
              to="/catalog"
              className="flex items-center gap-1 text-sm text-violet-600 hover:text-violet-700 font-medium bg-violet-50 hover:bg-violet-100 px-3 py-1.5 rounded-lg transition"
            >
              {t("featuredLots.viewAll")} <FaChevronRight className="text-xs" />
            </Link>
          </div>
        ...
        {list.length > 5 && (
          <div>
            <div className="flex items-center justify-between mb-4">
              <h2 className="text-lg font-bold text-gray-900">
                {t("featuredLots.moreTitle")}
              </h2>
              <Link
                to="/catalog"
                className="flex items-center gap-1 text-sm text-violet-600 hover:text-violet-700 font-medium bg-violet-50 hover:bg-violet-100 px-3 py-1.5 rounded-lg transition"
              >
                {t("featuredLots.viewAll")}{" "}
