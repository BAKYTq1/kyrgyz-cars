    ...
    >
        ...
        <div className="flex items-center gap-2 sm:gap-3">
          ...
          <div className="relative" onClick={(e) => e.stopPropagation()}>
            <button
              ...
              className="flex items-center gap-1 sm:gap-1.5 border border-slate-300 rounded-lg px-2 sm:px-4 py-1.5 text-xs sm:text-sm text-slate-700 bg-white cursor-pointer hover:bg-slate-50 transition-colors whitespace-nowrap"
            >
      ...
      <div className="bg-white border border-slate-200 rounded-xl py-10 sm:py-12 px-4 sm:px-6 text-center max-w-lg mx-auto">
        ...
        <p className="text-xs sm:text-sm text-slate-500 leading-relaxed max-w-sm mx-auto">
          „Проигранные автомобили" относятся к тем, на которые вы сделали
          ставки, но они были перебиты или продавец не принял ваше предложение.
          Здесь вы сможете получить доступ к списку этих автомобилей вместе с
          самой высокой ставкой, которую они получили на аукционе.
        </p>
      </div>
    </div>
  );
