        ...
        <div className="grid grid-cols-1 md:grid-cols-6 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm">
              ...
              <li>
                <Link
                  to="/how-it-works?phase=1"
                  className="hover:text-purple-400 transition"
                >
                  {t("footer.links.beforeBuy")}
                </Link>
              </li>
              <li>
                <Link
                  to="/how-it-works?phase=2"
                  className="hover:text-purple-400 transition"
                >
                  {t("footer.links.afterBuy")}
                </Link>
              </li>
              <li>
                <Link
          ...
          <div>
            <h4 className="text-white text-sm font-semibold mb-4">
              {t("footer.sections.keywords")}
            </h4>
            <ul className="space-y-3 text-sm">
              <li>
                <Link
                  to="/catalog?auction=iaai"
                  className="hover:text-purple-400 transition"
                >
                  IAAI
                </Link>
            ...
            <ul className="space-y-3 text-sm">
              <li>
                <Link
                  ...
                  className="hover:text-purple-400 transition"
                >
                  {t("footer.links.allAuctions")}
                </Link>
              </li>
              <li>
                <Link
                  to="/catalog?status=open"
                  className="hover:text-purple-400 transition text-gray-500"
                >
                  {t("footer.links.statusOpen")}
                </Link>
              </li>
              <li>
                <Link
                  to="/catalog?status=process"
                  className="hover:text-purple-400 transition text-gray-500"
                >
                  {t("footer.links.statusProcess")}
                </Link>
              </li>
              <li>
                <Link
                  to="/catalog?status=finished"
                  className="hover:text-purple-400 transition text-gray-500"
                >
                  {t("footer.links.statusFinished")}
                </Link>
              </li>
              <li>
                <Link
                  to="/catalog?status=buynow"
                  className="hover:text-purple-400 transition text-gray-500"
                >
                  {t("footer.links.statusBuyNow")}
                </Link>
              </li>
              <li>
                <Link
                  to="/archive"
                  className="hover:text-purple-400 transition mt-2 block"
                >
      ...
      <div className="border-t border-gray-700">
        <div className="max-w-7xl mx-auto px-6 py-4 flex flex-wrap items-center justify-between gap-3 text-xs text-gray-500">
          <div className="flex gap-4">
            <Link to="/rules" className="hover:text-purple-400 transition">
